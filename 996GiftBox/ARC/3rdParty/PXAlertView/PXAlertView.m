         ...
         completion:(PXAlertViewCompletionBlock)completion
{
    ...
    if (self) {
        ...
        _alertView.backgroundColor = KT_HEXCOLOR(0xf5f5f5);//[UIColor colorWithWhite:0.25 alpha:1];
        ...
        _titleLabel.textColor = KT_HEXCOLOR(0x333333);
        _titleLabel.textAlignment = NSTextAlignmentCenter;
        _titleLabel.font = GB_DEFAULT_FONT(17.5);
        ...
        _messageLabel.textColor = KT_HEXCOLOR(0x666666);
        _messageLabel.textAlignment = NSTextAlignmentCenter;
        _messageLabel.font = GB_DEFAULT_FONT(15);
...
- (UIButton *)genericButton
{
    ...
    button.titleLabel.font = GB_DEFAULT_FONT(17);//[UIFont systemFontOfSize:17];
...
//    [sender setBackgroundColor:[UIColor colorWithRed:94/255.0 green:196/255.0 blue:221/255.0 alpha:1.0]];
    [sender setBackgroundColor:KT_HEXCOLOR(0xd9d9d9)];
}
...
- (CALayer *)lineLayer
{
    ...
    lineLayer.backgroundColor = KT_HEXCOLOR(0xb4b4b4).CGColor;//KT_UIColorWithRGBA(180, 180, 180, 0.3f).CGColor;//[[UIColor colorWithWhite:0.90 alpha:0.3] CGColor];
    return lineLayer;
}
...
- (NSInteger)addButtonWithTitle:(NSString *)title
{
    ...
    if (!self.cancelButton) {
        ...
        [self.cancelButton setTitleColor:KT_HEXCOLOR(0xff8500) forState:UIControlStateNormal];
