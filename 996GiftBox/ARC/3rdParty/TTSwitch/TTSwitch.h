...
@property (nonatomic, KT_STRONG) UIImage *trackImage UI_APPEARANCE_SELECTOR;
@property (nonatomic, KT_STRONG) UIImage *overlayImage UI_APPEARANCE_SELECTOR;
@property (nonatomic, KT_STRONG) UIImage *thumbImage UI_APPEARANCE_SELECTOR;
@property (nonatomic, KT_STRONG) UIImage *thumbHighlightImage UI_APPEARANCE_SELECTOR;

@property (nonatomic, KT_STRONG) UIImage *trackMaskImage UI_APPEARANCE_SELECTOR;
@property (nonatomic, KT_STRONG) UIImage *thumbMaskImage UI_APPEARANCE_SELECTOR;
