...
@property (nonatomic, KT_STRONG) UIImageView *trackImageView;
@property (nonatomic, KT_STRONG) UIImageView *overlayImageView;
@property (nonatomic, KT_STRONG) UIImageView *thumbImageView;

@property (nonatomic, KT_STRONG) UIView *maskedTrackView;
@property (nonatomic, KT_STRONG) UIView *maskedThumbView;

@property (nonatomic, KT_STRONG) CALayer *trackMaskLayer;
@property (nonatomic, KT_STRONG) UIImage *onTrackMaskImage;
@property (nonatomic, KT_STRONG) UIImage *offTrackMaskImage;
...
- (void)updateThumbPositionAnimated:(BOOL)animated
{
    ...
    [self thumbImageHighlighted:_on];
